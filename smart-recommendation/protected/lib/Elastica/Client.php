<?php
    ...
    class Elastica_Client {
         ...
         * @var array
         */
        protected $_config = array('host' => self::DEFAULT_HOST, 'port' => self::DEFAULT_PORT, 'path' => '', 'url' => null, 'transport' => self::DEFAULT_TRANSPORT, 'persistent' => true, 'timeout' => self::TIMEOUT, 'headers' => array(), 'servers' => array(), 'curl' => array(), 'roundRobin' => false, 'log' => false, 'retryOnConflict' => 0,);
        ...
        public function updateDocument($id, Elastica_Script $script, $index, $type, array $options = array()) {
            ...
            $data = array('script' => $script->getScript(),);
        ...
        public function deleteIds(array $ids, $index, $type) {
            ...
            $params = array();
            foreach ($ids as $id) {
                $action = array('delete' => array('_index' => $index, '_type' => $type, '_id' => $id,));
